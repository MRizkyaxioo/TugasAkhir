...
<head>
    ...
    <title>Reset Password - Magang Poliban</title>
...
<input
    ...
    value="{{ $email }}">
                    ...
                    <div class="field">
                        ...
                        <div class="input-wrap">
                            <input type="password" name="password" id="passwordBaru" required>
                            <svg id="eyeBaru"
                    ...
                    <div class="field">
                        ...
                        <div class="input-wrap">
                            <input type="password" name="password_confirmation" id="passwordKonfirmasi" required>
                            <svg id="eyeKonfirmasi"
                                 onclick="togglePassword('passwordKonfirmasi','eyeKonfirmasi')"
                                 width="16" height="16" viewBox="0 0 24 24" fill="none"
                                 stroke="currentColor" stroke-width="2"
                                 stroke-linecap="round" stroke-linejoin="round"
                                 style="cursor:pointer; pointer-events:all;">
