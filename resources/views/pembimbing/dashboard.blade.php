    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .card {
            ...
            padding: 24px 28px;
            /* Lebar penuh — tidak ada max-width agar tabel tidak perlu scroll */
            width: 100%;
        }
        ...
        .filter-group {
            ...
            flex-direction: column;
            gap: 4px;
            flex: 1;                   /* tiap group mengisi ruang proporsional */
        ...
        @media (max-width: 900px) {
            ...
            /* Filter boleh wrap di tablet */
            .filter-bar {
                flex-wrap: wrap;
            }

            .filter-group {
                flex: 1 1 calc(50% - 6px); /* 2 kolom di tablet */
                min-width: 140px;
            }
        ...
        @media (max-width: 700px) {
            ...
            /* Filter: 1 kolom penuh di mobile */
