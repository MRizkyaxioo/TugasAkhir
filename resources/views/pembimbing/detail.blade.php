...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/pembimbing/detail.css') }}">
</head>
<body>
        ...
        <div class="detail-grid">
            ...
            <div class="card">
                ...
                <div class="kehadiran-grid">
                    <div class="kehadiran-box box-hadir">
                        <div class="k-label">Hadir</div>
                        <div class="k-value">{{ $hadir }}</div>
                        <div class="k-unit">Hari</div>
                    </div>
                    <div class="kehadiran-box box-izin">
                        <div class="k-label">Izin</div>
                        <div class="k-value">{{ $izin }}</div>
                        <div class="k-unit">Hari</div>
                    </div>
                    <div class="kehadiran-box box-sakit">
                        <div class="k-label">Sakit</div>
                        <div class="k-value">{{ $sakit }}</div>
                        <div class="k-unit">Hari</div>
                    </div>
                    <div class="kehadiran-box box-alpa">
                        <div class="k-label">Alpa</div>
                        <div class="k-value">{{ $alpa }}</div>
                        <div class="k-unit">Hari</div>
                    </div>
                </div>
            </div>
