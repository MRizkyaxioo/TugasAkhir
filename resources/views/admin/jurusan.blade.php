...
<head>
    ...
    <link href="{{ asset('css/admin/jurusan.css') }}" rel="stylesheet">
</head>
<body>
    ...
    <aside class="sidebar" id="sidebarAdmin">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('admin.jurusan') }}" class="nav-item active">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <a href="{{ route('admin.sekolah') }}" class="nav-item">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
@endif
                ...
                <!-- KANAN: FORM TAMBAH -->
                <div class="card">
                    <div class="card-label">Tambah Jurusan</div>
