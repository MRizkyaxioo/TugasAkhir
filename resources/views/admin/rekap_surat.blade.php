...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .badge-izin  { background: #FEF9C3; color: #92400E; border: 1px solid #FDE68A; }
        .badge-sakit { background: #E0F2FE; color: #075985; border: 1px solid #BAE6FD; }
...
<body>
    ...
    <div class="main-content">
        <div class="page-header">
            <div class="page-header-title">Rekap Surat</div>
        </div>
