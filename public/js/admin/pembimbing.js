...
function openEditModal(id, nama, no_telp, nip_nidn, username)
{
    ...
    // isi juga action form hapus supaya tombol Hapus di modal tahu id yang aktif
    document.getElementById('deleteFormPembimbing').action =
        `/admin/pembimbing/delete/${id}`;
}
// =========================
...
)
{
    ...
    // isi juga action form hapus supaya tombol Hapus di modal tahu id yang aktif
    document.getElementById('deleteFormPembimbingAsal').action =
        `/admin/pembimbing-asal/delete/${id}`;
}
